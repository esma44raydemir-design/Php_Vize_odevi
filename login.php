...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['giris_yap'])) {
    ...
    if (isset($_SESSION['users'][$username]) && $_SESSION['users'][$username] === $password) {
        ...
        header("Location: dashboard.php"); // Giriş başarılıysa panele yolla
        exit;
    } else {
        $mesaj = "<div class='bildirim hata'>Hatalı kullanıcı adı veya şifre!</div>";
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Giriş Yap | Portfolyo</title>
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;900&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
    <style>
        /* CSS kodları register.php ile tamamen aynıdır */
...
<body>
    <div class="auth-card">
        ...
        <a href="register.php" class="alt-link">Hesabın yok mu? Kayıt Ol</a><br>
